...
public class OPiece extends Piece {
    ...
    public OPiece() {
        ...
        patterns[0].addSquare(2, 0, 0);
        patterns[0].addSquare(3, 1, 0);

        patterns[0].setNextPattern(patterns[1]);
        patterns[0].setPreviousPattern(patterns[3]);

        patterns[1].addSquare(0, 0, 1);
        patterns[1].addSquare(1, 1, 1);
        patterns[1].addSquare(2, 0, 0);
        patterns[1].addSquare(3, 1, 0);
        ...
        patterns[2].addSquare(2, 0, 0);
        patterns[2].addSquare(3, 1, 0);
