...
public class SPiece extends Piece {
    ...
    public SPiece() {
        ...
        patterns[0].addSquare(0, 0, 1);
        patterns[0].addSquare(1, 1, 1);
        patterns[0].addSquare(2, 1, 2);
        patterns[0].addSquare(3, 2, 2);

        patterns[0].setNextPattern(patterns[1]);
        patterns[0].setPreviousPattern(patterns[3]);

        patterns[1].addSquare(0, 1, 2);
        patterns[1].addSquare(1, 1, 1);
        patterns[1].addSquare(2, 2, 1);
        patterns[1].addSquare(3, 2, 0);

        patterns[1].setNextPattern(patterns[2]);
        patterns[1].setPreviousPattern(patterns[0]);

        patterns[2].addSquare(0, 0, 0);
        patterns[2].addSquare(1, 1, 0);
        ...
        patterns[3].addSquare(0, 0, 2);
        patterns[3].addSquare(1, 0, 1);
        patterns[3].addSquare(2, 1, 1);
        patterns[3].addSquare(3, 1, 0);
